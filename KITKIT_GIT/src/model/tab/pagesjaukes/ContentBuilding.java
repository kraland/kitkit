...
public class ContentBuilding implements I_DefaultContent
{
	/**
	 * Liste de string
	 */
	 ...
	 */
	private	String s_nameOrganization;
	...
	public void add(List<String> listString) {
		...
		// On recupere le string contenant le nom de l'organisation
		s_nameOrganization = listString.get(11);
		
		// On recupere l'entier contenant la valeur du batiment
		s_value = listString.get(12);
		...
		listObject.add(s_nameOrganization);
		listObject.add(s_value);
