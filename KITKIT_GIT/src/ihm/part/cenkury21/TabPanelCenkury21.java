...
public class TabPanelCenkury21 extends JPanel implements 	I_Viewable,
															I_ControllerDialog,
															...
															I_SplitPaneView
{
	...
	/**
	 * Panel affichant la partie configuration de l'onglet Cenkury21
	 */
	private PanelCenkury21Config panelCenkury21Config;
	
	/**
	 * Panel affichant la partie resultat de l'onglet Cenkury21
	 */
	private PanelCenkury21Result panelCenkury21Result;
  
	/**
	 * Constructeur de l'onglet Cenkury21
	 */
	public TabPanelCenkury21()
	{
		// On change le layout
 	...
 	public void initObject()
	{
 		...
 		panelCenkury21Config = new PanelCenkury21Config();
 		
 		// On initialise le panel de resultat
 		panelCenkury21Result = new PanelCenkury21Result();

		// On ajoute les deux panels au SplitPane
		splitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT,new JScrollPane(panelCenkury21Config),panelCenkury21Result);
	...
	public void addI_Viewable()
	{
		...
		panelCenkury21Config.setListI_Viewable(listI_Viewable);
		panelCenkury21Result.setListI_Viewable(listI_Viewable);
	}
	...
	public void setController(Controller ctrl) {
		this.ctrl = ctrl;
		panelCenkury21Config.setController(ctrl);
		panelCenkury21Result.setController(ctrl);
